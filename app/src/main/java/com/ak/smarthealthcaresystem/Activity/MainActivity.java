...
import com.ak.smarthealthcaresystem.ModelClass.Hospital;
import com.ak.smarthealthcaresystem.ModelClass.Laboratory;
import com.ak.smarthealthcaresystem.ModelClass.User;
...
import com.ak.smarthealthcaresystem.Utilities.CustomDateValidator;
import com.ak.smarthealthcaresystem.databinding.ActivityMainBinding;
import com.ak.smarthealthcaresystem.databinding.DgNewUserBinding;
            ...
            switch (requestCode) {
                case PICK_VERIFICATION_PROOF:
                    if (tvFile != null && data != null && data.getData() != null) {
                        ...
                        filePathUri = FileProvider.getUriForFile(mContext, "com.ak.smarthealthcaresystem.fileprovider", new File(CU.getPath(mContext, uri)));
